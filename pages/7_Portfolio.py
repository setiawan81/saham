...
# ── DISCLAIMER ────────────────────────────────────────────────────────────────
st.markdown("---")
st.caption("⚠️ Portfolio tracker ini tidak menyimpan data secara permanen. Data akan hilang saat halaman di-refresh. Selalu konsultasikan keputusan investasi dengan pertimbangan matang.")
